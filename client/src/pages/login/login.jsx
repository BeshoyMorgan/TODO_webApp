...
const LoginPage = () => {
  ...
  return (
    <div className="h-screen w-screen flex justify-center items-center ">
      ...
      <div className="h-4/5 w-3/4 lg:h-4/5 lg:w-1/4  absolute bg-white pt-10 rounded-lg">
       
          <h3 className="uppercase font-thin  text-center text-4xl  text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-400">login</h3>
      <form onSubmit={handleSubmit(onSubmit)}
      className=" flex flex-col gap-4 py-1 px-10 justify-center items-center w-full h-full"
      >
          ...
          <div className="relative w-full">
            ...
            <label
              ...
              className="absolute text-sm text-gray-500
               dark:text-gray-400 duration-300 transform -translate-y-3 
               scale-75 top-1 z-10 origin-[0] bg-white
                dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-cyan-500 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-1 peer-focus:scale-75 peer-focus:-translate-y-3 left-1"
...
<div className="flex gap-2 text-md text-gray-500 justify-center  mb-8">
            ...
            <Link to={`/signup`} className="font-bold uppercase underline">sign up</Link>
          </div>
      </form>
